<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Dashboard.Master" AutoEventWireup="true" CodeBehind="Withdraw.aspx.cs" Inherits="Online_Banking_Mid.Admin.Withdraw" %>
    ...
    <div align="center">
        ...
        <table cellspacing="5">
                ...
                <tr>
                    ...
                    <td> <asp:TextBox ID="amount_no_box" runat="server" TextMode="Number" Width="178px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td></td>
