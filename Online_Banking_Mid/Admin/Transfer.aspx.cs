    ...
    public partial class Transfer : System.Web.UI.Page
    {
        ...
        protected void transfer()
        {
            try
            {
                ...
                string checkReciver = "select acc_balance from users Where acc_no ='" + to_acc_box.Text + "' ;";
                ...
                if (dr.Read())
                {
                    ...
                    string fromsql = "update users set acc_balance-='" + amount_box.Text + "' Where (acc_no='" + from_acc_box.Text + "') And (acc_balance >'" + amount_box.Text + "');";
        ...
        protected void transactionInfo()
        {
            ...
            try
            {
                string newsql = "insert into users_transaction_info Values ('" + from_acc_box.Text + "','" + to_acc_box.Text + "','" + amount_box.Text + "','" + t + "','" + currentTime + "') ";
